/**
 * PhotoLibraryEnableModal - Elegant modal guiding users through iOS Settings setup.
 *
 * Design: "Field Guide Instruction Card" - vintage travel guide aesthetic
 * with clear step-by-step instructions for enabling photo library access.
 *
 * Shown when user has denied photo permission and needs to enable via Settings.
 */
...
interface PhotoLibraryEnableModalProps {
  visible: boolean;
  onClose: () => void;
}
...
const STEPS = [
  ...
  { number: '3', text: 'Tap "Photos"' },
  { number: '4', text: 'Select "Full Access" or "Limited Access"' },
];

export function PhotoLibraryEnableModal({ visible, onClose }: PhotoLibraryEnableModalProps) {
  // Animation values
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.header}>
            <Text style={styles.title}>Enable Photo Import</Text>
            <Text style={styles.subtitle}>Discover trips from your travel photos</Text>
          </View>
