...
export function HomeCountryScreen({ navigation }: Props) {
  ...
  useEffect(() => {
    ...
    // Subtle floating animation for pin
    Animated.loop(
      Animated.sequence([
      ...
      <View style={styles.content}>
        ...
        <Animated.View
          style={[
            ...
            {
              opacity: pinOpacity,
              transform: [{ scale: pinScale }, { translateY: pinBounce }],
            },
          ]}
        >
        ...
        <Animated.View style={[styles.footer, { opacity: buttonOpacity }]}>
          <TouchableOpacity
            style={[styles.nextButton, !homeCountry && styles.nextButtonDisabled]}
            onPress={handleNext}
      ...
      {showSelection && selectedCountryData && (
        ...
        >
          ...
          >
            ...
            >
              <Ionicons name="checkmark-circle" size={32} color={colors.mossGreen} />
...
const styles = StyleSheet.create({
  ...
  dropdownItem: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: colors.dustyCoral,
  },
  flagEmoji: {
    fontSize: 28,
    marginRight: 16,
