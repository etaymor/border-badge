 ...
 * Sorted by likely usage (common countries first), then alphabetically.
 */
...
// Create lookup map for quick O(1) access by country code
const COUNTRY_BY_CODE = new Map(COUNTRY_DIAL_CODES.map((c) => [c.code, c]));

/**
 * Get country by ISO 2-letter code.
 * Defaults to US if code not found.
 */
export function getCountryByCode(code: string | null): CountryDialCode {
