...
const REFINED_PATHS = {
  ...
  Oceania:
    'M867.6,321.7 c-13.3-5.3-28-1.3-37.3,9.3 c-9.3,10.7-9.3,26.7,0,37.3 c9.3,10.7,25.3,13.3,37.3,8 c12-5.3,18.7-18.7,17.3-32 C883.6,333.7,878.3,325.7,867.6,321.7 z',

  Antarctica:
    'M500,480 c-133.3,0-253.3,5.3-266.7,13.3 c13.3,5.3,133.3,6.7,266.7,6.7 s253.3-1.3,266.7-6.7 C753.3,485.3,633.3,480,500,480 z',
};
