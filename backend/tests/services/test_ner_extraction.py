...
class TestInferPlaceType:
    ...
    def test_fac_label_defaults_to_tourist_attraction(self):
    ...
    def test_no_type_for_generic_loc(self):
    ...
    def test_bar_harbor_not_bar(self):
